        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              InkWell(
                onTap: () => Navigator.pushNamed(context, "chooseAdType2"),
                child: Container(
                  ...
                  child: const Row(
                    ...
                    children: [
                      Text("فروش ملک", style: TextStyle(fontSize: 16),),
              ...
              Container(
                ...
                child: const Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("اجاره ملک", style: TextStyle(fontSize: 16),),
                    Icon(Icons.arrow_forward_ios_rounded, size: 18,),
                  ],
                ),
              ),
              Container(
                ...
                child: const Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("مشارکت در ساخت ملک", style: TextStyle(fontSize: 16),),
                    Icon(Icons.arrow_forward_ios_rounded, size: 18,),
                  ],
                ),
              ),
              Container(
                ...
                child: const Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("پیش فروش ملک", style: TextStyle(fontSize: 16),),
                    Icon(Icons.arrow_forward_ios_rounded, size: 18,),
                  ],
                ),
              ),
              Container(
                ...
                child: const Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("اجاره کوتاه مدت", style: TextStyle(fontSize: 16),),
                    Icon(Icons.arrow_forward_ios_rounded, size: 18,),
                  ],
                ),
              ),
